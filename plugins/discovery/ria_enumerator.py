        ...
        if not self._exec:
            ...
            for ext in self._extensions:
                for word in file(self._wordlist):
                    ...
                    http_response = self._url_opener.GET( manifest_url, useCache=True )
            ...
            response = self._url_opener.GET( cross_domain_url, useCache=True )
            ...
            response = self._url_opener.GET( client_access_url, useCache=True )
