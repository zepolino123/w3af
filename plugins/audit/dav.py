...
class dav(baseAuditPlugin):
    ...
    def _SEARCH( self, domain_path ):
        ...
        res = self._url_opener.SEARCH( domain_path , data=content )
    ...
    def _PROPFIND( self, domain_path ):
        ...
        res = self._url_opener.PROPFIND( domain_path , data=content, headers={'Depth': '1'} )
    ...
    def _PUT( self, domain_path ):
        ...
        put_response = self._url_opener.PUT( url , data=rndContent )
        
        # check if uploaded
        res = self._url_opener.GET( url , useCache=True )
