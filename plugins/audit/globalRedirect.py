...
class globalRedirect(baseAuditPlugin):
    ...
    def __init__(self):
        ...
        self._analyze_response_body = True
    ...
    def _find_redirect( self, response ):
        ...
        if not self._analyze_response_body:
            return False
    ...
    def getOptions( self ):
        ...
        '''    
        ol = optionList()
        d1 = 'Search for redirects in meta-tags and JavaScript'
        h1 = 'If set to True, w3af besides HTTP return codes '
        h1 += 'will also try to find redirects inside response body in meta-tags and Javascript '
        o1 = option('analyzeResponseBody', self._analyze_response_body, d1, 'boolean', help=h1)
        ol.add(o1)
        return ol
    ...
    def setOptions(self, optionsMap):
        ...
        ''' 
        self._analyze_response_body = optionsMap['analyzeResponseBody'].getValue()
